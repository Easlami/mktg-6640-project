...
### Spliting into top and bad Korean Restaurants 
...
custom_stopwords <- c(stopwords("english"), "also", "use", "used", "food", "restaurant")
...
lda_model <- LDA(dtmtop, k=10, control = list(seed = 123))
...
lda_model_bad <- LDA(dtmfilteredbad, k=10, control = list(seed = 123))
